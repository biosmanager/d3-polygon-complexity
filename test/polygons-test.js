...
tape("square", function (test) {
    ...
    console.log(polygonComplexity.polygonAreaDeviation(polygons.squareCw) + " " + polygonComplexity.polygonAreaDeviation(polygons.squareCcw));
    test.assert(polygonComplexity.polygonAreaDeviation(polygons.squareCw) == polygonComplexity.polygonAreaDeviation(polygons.squareCcw), "hull deviation");
...
tape("cross", function (test) {
    ...
    console.log(polygonComplexity.polygonAreaDeviation(polygons.crossCw) + " " + polygonComplexity.polygonAreaDeviation(polygons.crossCcw));
    test.assert(polygonComplexity.polygonAreaDeviation(polygons.crossCw) == polygonComplexity.polygonAreaDeviation(polygons.crossCcw), "hull deviation");
